<template>
  <div class="glass-effect fixed bottom-0 left-0 right-0 z-50 border-t border-primary/20 p-4 pb-8 md:pb-6">
    <div class="mx-auto flex w-full max-w-6xl gap-3 md:max-w-xl">
      <a
        :href="whatsappHref"
        target="_blank"
        rel="noreferrer"
        class="flex flex-1 items-center justify-center gap-3 rounded-xl bg-[#25D366] py-4 text-lg font-bold text-white shadow-lg shadow-[#25D366]/20"
      >
        <svg class="size-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path
